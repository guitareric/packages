...
const handlePage = require('../../client/src/utils/zillow-homie-helpers')

const routes = express.Router()

routes.use('/zillow-homie-bot', async (req, res) => {
  const url =
  ...
  const zillowHomieResults = await handlePage(page, browser)
  res.json(zillowHomieResults)
})
